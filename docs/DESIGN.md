...
| `DELETE` | `/v1/iscsi/targets/:iqn/luns/:n` | Unmap + delete backstore; `?destroyBacking=true` also destroys the zvol/image behind the confirm gate; a LUN in use by a live session → `409`, no bypass (operator ruling 2026-08-26) | `202`/`409` |
